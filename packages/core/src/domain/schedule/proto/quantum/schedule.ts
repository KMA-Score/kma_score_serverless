...
export const SemesterData = {
  ...
  create<I extends Exact<DeepPartial<SemesterData>, I>>(
    base?: I,
  ): SemesterData {
    return SemesterData.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<SemesterData>, I>>(
    object: I,
  ): SemesterData {
    const message = createBaseSemesterData();
...
export const GetSemesterListReq = {
  ...
  create<I extends Exact<DeepPartial<GetSemesterListReq>, I>>(
    base?: I,
  ): GetSemesterListReq {
    return GetSemesterListReq.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetSemesterListReq>, I>>(
    _: I,
  ): GetSemesterListReq {
    const message = createBaseGetSemesterListReq();
    return message;
...
export const GetSemesterListRsp = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          ...
          message.semesterList.push(
            SemesterData.decode(reader, reader.uint32()),
          );
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  toJSON(message: GetSemesterListRsp): unknown {
    ...
    if (message.semesterList?.length) {
      obj.semesterList = message.semesterList.map((e) =>
        SemesterData.toJSON(e),
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<GetSemesterListRsp>, I>>(
    base?: I,
  ): GetSemesterListRsp {
    return GetSemesterListRsp.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetSemesterListRsp>, I>>(
    object: I,
  ): GetSemesterListRsp {
    const message = createBaseGetSemesterListRsp();
    ...
    message.semesterList =
      object.semesterList?.map((e) => SemesterData.fromPartial(e)) || [];
    return message;
  },
};
...
export const StudentSchedule = {
  ...
  fromJSON(object: any): StudentSchedule {
    return {
      ...
      subjectCode: isSet(object.subjectCode)
        ? globalThis.String(object.subjectCode)
        : '',
      ...
      subjectName: isSet(object.subjectName)
        ...
        : undefined,
      teacher: isSet(object.teacher)
        ? globalThis.String(object.teacher)
        : undefined,
  ...
  create<I extends Exact<DeepPartial<StudentSchedule>, I>>(
    base?: I,
  ): StudentSchedule {
    return StudentSchedule.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<StudentSchedule>, I>>(
    object: I,
  ): StudentSchedule {
    const message = createBaseStudentSchedule();
...
export const StudentInfo = {
  ...
  fromJSON(object: any): StudentInfo {
    return {
      ...
      displayName: isSet(object.displayName)
        ...
        : '',
      studentClass: isSet(object.studentClass)
        ? globalThis.String(object.studentClass)
        : '',
    };
  },
  ...
  fromPartial<I extends Exact<DeepPartial<StudentInfo>, I>>(
    object: I,
  ): StudentInfo {
    const message = createBaseStudentInfo();
...
export const GetScheduleByStudentCodeReq = {
  ...
  fromJSON(object: any): GetScheduleByStudentCodeReq {
    return {
      studentCode: isSet(object.studentCode)
        ? globalThis.String(object.studentCode)
        : '',
      semesterHash: isSet(object.semesterHash)
        ? globalThis.String(object.semesterHash)
        : '',
    };
  },
  ...
  create<I extends Exact<DeepPartial<GetScheduleByStudentCodeReq>, I>>(
    base?: I,
  ): GetScheduleByStudentCodeReq {
    return GetScheduleByStudentCodeReq.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetScheduleByStudentCodeReq>, I>>(
    object: I,
  ): GetScheduleByStudentCodeReq {
    const message = createBaseGetScheduleByStudentCodeReq();
    message.studentCode = object.studentCode ?? '';
...
export const GetScheduleByStudentCodeRsp = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 4:
          ...
          message.studentSchedule.push(
            StudentSchedule.decode(reader, reader.uint32()),
          );
          continue;
      }
      if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): GetScheduleByStudentCodeRsp {
    return {
      code: isSet(object.code) ? globalThis.Number(object.code) : 0,
      message: isSet(object.message) ? globalThis.String(object.message) : '',
      studentInfo: isSet(object.studentInfo)
        ? StudentInfo.fromJSON(object.studentInfo)
        : undefined,
  ...
  toJSON(message: GetScheduleByStudentCodeRsp): unknown {
    ...
    if (message.studentSchedule?.length) {
      obj.studentSchedule = message.studentSchedule.map((e) =>
        StudentSchedule.toJSON(e),
      );
    }
    return obj;
  },

  create<I extends Exact<DeepPartial<GetScheduleByStudentCodeRsp>, I>>(
    base?: I,
  ): GetScheduleByStudentCodeRsp {
    return GetScheduleByStudentCodeRsp.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<GetScheduleByStudentCodeRsp>, I>>(
    object: I,
  ): GetScheduleByStudentCodeRsp {
    const message = createBaseGetScheduleByStudentCodeRsp();
    message.code = object.code ?? 0;
    message.message = object.message ?? '';
    message.studentInfo =
      object.studentInfo !== undefined && object.studentInfo !== null
        ? StudentInfo.fromPartial(object.studentInfo)
        : undefined;
    message.studentSchedule =
      object.studentSchedule?.map((e) => StudentSchedule.fromPartial(e)) || [];
    return message;
  },
};
