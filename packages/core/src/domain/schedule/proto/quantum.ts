...
import { GetStudentTuitionFeeReq, GetStudentTuitionFeeRsp } from "./quantum/student";
...
export const KmaQuantumServiceService = {
  ...
  getStudentTuitionFee: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetStudentTuitionFeeReq) => Buffer.from(GetStudentTuitionFeeReq.encode(value).finish()),
    requestDeserialize: (value: Buffer) => GetStudentTuitionFeeReq.decode(value),
    responseSerialize: (value: GetStudentTuitionFeeRsp) => Buffer.from(GetStudentTuitionFeeRsp.encode(value).finish()),
    responseDeserialize: (value: Buffer) => GetStudentTuitionFeeRsp.decode(value),
  },
} as const;
...
export interface KmaQuantumServiceServer extends UntypedServiceImplementation {
  ...
  getStudentTuitionFee: handleUnaryCall<GetStudentTuitionFeeReq, GetStudentTuitionFeeRsp>;
}
...
export interface KmaQuantumServiceClient extends Client {
  ...
  getStudentTuitionFee(
    ...
    callback: (error: ServiceError | null, response: GetStudentTuitionFeeRsp) => void,
  ): ClientUnaryCall;
  getStudentTuitionFee(
    request: GetStudentTuitionFeeReq,
    metadata: Metadata,
...
export const KmaQuantumServiceClient = makeGenericClientConstructor(
  ...
  new (address: string, credentials: ChannelCredentials, options?: Partial<ClientOptions>): KmaQuantumServiceClient;
