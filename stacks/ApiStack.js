...
export function API(stackContext) {
    ...
    const api = new Api(stack, 'api', {
        ...
        routes: {
            'GET /student/{id}': 'packages/functions/src/student/getAllStudentWithScore.handler',
        },
        ...
        customDomain: app.local
            ...
            : {
                ...
                cdk: {
                    // eslint-disable-next-line @typescript-eslint/ban-ts-comment
                    // @ts-ignore
                    certificate: Certificate.fromCertificateArn(stack, 'score_api_certificate', process.env.CERTIFICATE_ARN ?? ''),
                },
            },
    });
    stack.addOutputs({
